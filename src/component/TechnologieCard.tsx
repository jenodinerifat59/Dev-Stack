...
const TechnologieCard = ({ technologie }: TechnologieCardType) => {
    return (
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 ">
            ...
            <button className="w-full py-3 rounded-xl bg-gradient-to-r from-[#FF5722] to-[#D81B7E] text-white font-semibold hover:bg-blue-700 active:scale-95 transition-all duration-200">
                Add to Stack
            </button>
        </div>
    )

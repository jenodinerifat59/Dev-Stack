        ...
        <nav className="w-full">
            <div className="container mx-auto flex items-center justify-between px-4 py-4">
                ...
                <div className=" lg:flex items-center gap-2">
                    <button className="font-semibold text-[14px] text-[#334155] bg-transparent rounded-full py-2.5 px-5">
                        Sign In
                    </button>

                    <button className="font-semibold text-[14px] text-white rounded-full bg-[#D91B7E] py-2.5 px-5">
                        Sign Up
                    </button>
                </div>
